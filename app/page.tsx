...
const projects: Project[] = [
  ...
  },
  {
    name: "DEV-DNA",
    description:
      "An AI powered analysis engine which scrapes your Github profile to give genuine outputs like suggestions, analysis, roast etc. without sounding too generic and robotic.",
...
const iconMap = {
  "Warranty Vault": ShieldCheckIcon, // If project name is 'Warranty Vault', use ShieldCheck icon
